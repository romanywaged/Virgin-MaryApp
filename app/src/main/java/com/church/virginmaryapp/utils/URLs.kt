...
const val EVENT_RESERVATION = "eventreservation"
const val EVENT_DELETE = "eventreservation"
const val FOLLOW_EVENT_RESRVATION = "eventreservation/bynationalid/{nationalId}"
